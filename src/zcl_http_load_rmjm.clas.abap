CLASS zcl_http_load_rmjm DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS zcl_http_load_rmjm IMPLEMENTATION.
...
* Load the data to the table via dynamic internal table
        ...
        TRY.
          ...
          CATCH cx_sy_create_data_error INTO
          DATA(cd_exception).
  ...
  METHOD get_input_field_value.
    ...
    FIELD-SYMBOLS: <value> TYPE data,
                   <field> TYPE any.
    ASSIGN COMPONENT name OF STRUCTURE dataref TO
    <field>.
